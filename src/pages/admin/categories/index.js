...
export default function AdminCategories() {
  ...
  return (
    <>
      <Head><title>Categories | GenZ Admin</title><meta name="robots" content="noindex,nofollow" /></Head>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden max-w-2xl">
          {loading ? (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-[11px] uppercase tracking-wider bg-slate-50 text-slate-500 border-b border-slate-100">
