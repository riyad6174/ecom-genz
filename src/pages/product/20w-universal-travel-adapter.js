...
const ProductDetails = ({ initialProduct }) => {
  ...
  const reviewsData = [
    ...
    },
    {
      name: 'নীলিমা আহমেদ',
      rating: 4,
      text: '২০W অ্যাডাপ্টার দিয়ে ল্যাপটপও চার্জ করছি। বিভিন্ন দেশের সকেটে ফিট হয়েছে, কিন্তু একটু ভারী লাগে ব্যাগে। তবু সুপার প্রোডাক্ট!',
    },
  ];
  ...
  return (
    <>
      <Head>
        <title>20W Universal Travel Adapter | GenZ Shop</title>
        <meta
          name='description'
          content='Discover the 20W Universal Travel Adapter at GenZ Shop. Compatible worldwide plugs, fast charging PD/QC, compact design for travel.'
        />
        <meta
          property='og:title'
          content='20W Universal Travel Adapter | GenZ Shop'
        />
        <meta
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: '20W Universal Travel Adapter | GenZ Shop',
              sku: product.id,
              brand: {
                '@type': 'Brand',
                name: 'Universal',
          ...
          <div className='bg-white p-4 sm:p-5 rounded-lg'>
            ...
            <ul className='space-y-3 text-gray-700 font-mont text-sm sm:text-base'>
              ...
              <li className='flex flex-col md:flex-row items-start md:items-center gap-3'>
                ...
                PD 3.0 এবং QC 3.0 সাপোর্ট, ২০W আউটপুট।
              </li>
              <li className='flex flex-col md:flex-row items-start md:items-center gap-3'>
                <span className='font-semibold flex items-center gap-2'>
                  <FaPlug /> Multi-Port:
