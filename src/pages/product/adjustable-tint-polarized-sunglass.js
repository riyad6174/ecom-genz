        ...
        <div className='container mx-auto px-4 lg:px-8 max-w-4xl'>
          ...
          <div className='bg-white rounded shadow-md p-8 md:p-12 mb-8'>
            <p className='text-gray-700 bangla text-lg leading-relaxed mb-5'>
              ...
              আপনার সেরা সঙ্গী। ১-৯ স্তরের অ্যাডজাস্টেবল লেন্স দিয়ে আপনি
              যেকোনো আলোর পরিস্থিতিতে দৃষ্টিকে পুরোপুরি নিয়ন্ত্রণ করতে
              পারবেন।
            </p>
            <p className='text-gray-700 bangla text-lg leading-relaxed mb-5'>
            ...
            <p className='text-gray-700 bangla text-lg leading-relaxed'>
              উচ্চমানের হালকা উপাদান দিয়ে তৈরি এই সানগ্লাস টেকসই ও সারাদিন
              পরার জন্য আরামদায়ক। অ্যাডজাস্টেবল নোজ প্যাড ও নন-স্লিপ রাবার
              টেম্পল নিশ্চিত করে সুরক্ষিত ও স্বাচ্ছন্দ্যময় ফিটিং।
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-5 mb-8'>
            {[
              {
                icon: '🔆',
                title: '১-৯ স্তরের অ্যাডজাস্টেবল লেন্স',
          ...
          <div className='bg-white rounded shadow-md overflow-hidden'>
            ...
            <div className='divide-y divide-gray-100'>
              {[
                ...
                { l: 'উপযুক্ত', v: 'ড্রাইভিং, সাইক্লিং, ভ্রমণ, দৈনন্দিন ব্যবহার' },
              ].map((row, i) => (
                <div
                  key={row.l}
