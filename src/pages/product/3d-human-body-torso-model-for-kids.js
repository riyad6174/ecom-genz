...
const ProductDetails = ({ initialProduct }) => {
  ...
  const faqData = [
    {
      ...
      answer:
        'সাধারণত ১০-১৫ টি রিমুভেবল অঙ্গ থাকে (যেমন: হার্ট, লাংস, লিভার, স্টমাক, ইনটেস্টাইন, ব্রেন, কিডনি ইত্যাদি)। সঠিক সংখ্যা মডেলের ভার্সনের উপর নির্ভর করে – প্যাকেজিং-এ বিস্তারিত দেখুন।',
    },
    {
      question: 'এটি কোন বয়সের শিশুদের জন্য উপযুক্ত?',
      answer:
        'সাধারণত ৫–১২ বছর বয়সী শিশুদের জন্য আদর্শ। ছোট বাচ্চাদের ক্ষেত্রে অভিভাবকের তত্ত্বাবধানে ব্যবহার করা উচিত যাতে ছোট অংশ গিলে না ফেলে।',
    },
    {
  ...
  return (
    <>
      <Head>
        <title>
          ৩ডি হিউম্যান বডি টর্সো মডেল – কিডস অ্যানাটমি লার্নিং টয় | GenZ Shop
        </title>
        <meta
          name='description'
          content='শিশুদের জন্য ৩ডি হিউম্যান টর্সো মডেল – DIY অর্গান অ্যাসেম্বলি, এডুকেশনাল অ্যানাটমি টিচিং টুল। খেলতে খেলতেই মানবদেহ সম্পর্কে শিখুন!'
        />
        <meta
          property='og:title'
          content='৩ডি হিউম্যান বডি টর্সো মডেল – কিডস অ্যানাটমি লার্নিং টয় | GenZ Shop'
        />
        <meta
        ...
        <div className='px-3 sm:px-4'>
          ...
          <div className='bg-white p-4 sm:p-5 rounded-lg'>
            ...
            <p className='text-gray-600 font-mont text-sm sm:text-base'>
              ৩ডি হিউম্যান বডি টর্সো মডেল <br />
            ...
            <p className='py-3 text-gray-600 font-mont text-sm sm:text-base'>
              এই ৩ডি হিউম্যান বডি টর্সো মডেল শিশুদের জন্য বিশেষভাবে তৈরি একটি
            ...
            <ul className='list-disc list-inside space-y-2 text-gray-700 font-mont text-sm sm:text-base pl-4'>
              <li>মানবদেহের বিভিন্ন অঙ্গপ্রত্যঙ্গের ডিটেইলড ৩ডি ডিজাইন</li>
