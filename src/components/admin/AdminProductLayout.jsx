    ...
    <aside className="w-56 flex-shrink-0 flex flex-col bg-slate-100 border-r border-slate-200 min-h-full">
      <div className="px-4 py-4 border-b border-slate-200">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 bg-blue-600 rounded-md flex items-center justify-center text-white font-black text-sm">G</div>
          <div>
            <p className="font-black text-xs text-slate-900 leading-none">GenZ Admin</p>
      ...
      <nav className="flex-1 p-3 space-y-4 overflow-y-auto">
        ...
        <div className="pt-2 border-t border-slate-200">
          <NavItem href="/admin/orders" label="Orders" icon={FiGrid} active={path === '/admin/orders'} />
          <NavItem href="/admin/admins" label="Team" icon={FiGrid} active={path === '/admin/admins'} />
        </div>
      </nav>
